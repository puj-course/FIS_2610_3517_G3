...
public class AuthService {
    ...
    /**
     * Método register original (sin SMS) — mantenido para no romper tests existentes.
     * Los tests de AuthService usan esta firma.
     */
     ...
     * Si es correcto, marca la cuenta como verificada.
     */
